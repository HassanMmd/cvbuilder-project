        ...
        <div>
          <article className="services services2">
            <div className="top-services">
              ...
              <div>
                {info && <h4 className="item-num">1 in your list</h4>}
            ...
            <form onSubmit={addData}>
              ...
              <input type="text" className="form-control form-tex" id="role" name="role" value={formData.role} onChange={changeHandler} required></input>
              <label htmlFor="brief">Brief</label>
              <input type="text" className="form-control form-tex" id="brief" name="brief" value={formData.brief} onChange={changeHandler} required></input>
              <button disabled={info} type="submit" className="btn-submit btn btn-success">Add</button>
            </form>
          </article>
        ...
        <div>
          <article className="services services2-mobile">
            ...
            <form className="form-mobile" onSubmit={addData}>
              ...
              <label htmlFor="role">Role</label>
              <input type="text" className="form-control form-control-mobile form-tex" id="role" name="role" value={formData.role} onChange={changeHandler} required></input>
              <label htmlFor="brief">Brief</label>
              <input type="text" className="form-control form-control-mobile form-tex" id="brief" name="brief" value={formData.brief} onChange={changeHandler} required></input>
              <button disabled={info} type="submit" className="btn-submit-mobile btn btn-success">Add</button>
            </form>
          </article>
          {message && <div className="message alert alert-info" role="alert">{message}</div>}
        </div>
