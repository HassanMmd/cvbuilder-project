                ...
                <div>
                    <article className="services services2">
                        ...
                        <form onSubmit={addData}>
                            ...
                            <input type="text" className="form-control form-tex" id="role" name="role" value={formData.role} onChange={changeHandler} required maxLength={20}></input>
                            <label htmlFor="company">Company</label>
                            <input type="text" className="form-control form-tex" id="company" name="company" value={formData.company} onChange={changeHandler} required maxLength={20}></input>
                            ...
                            <textarea className="form-control form-tex" id="details" name="details" value={formData.details} onChange={changeHandler} required maxLength={80}></textarea>
                ...
                <div>
                    <article className="services services2-mobile">
                        ...
                        <form className="form-mobile" onSubmit={addData}>
                            <label htmlFor="role" >Role</label>
                            <input type="text" className="form-control form-control-mobile form-tex" id="role" name="role" value={formData.role} onChange={changeHandler} required maxLength={20}></input>
                            <label htmlFor="company">Company</label>
                            <input type="text" className="form-control form-control-mobile form-tex" id="company" name="company" value={formData.company} onChange={changeHandler} required maxLength={20}></input>
                            <label htmlFor="startDate">Start_date</label>
                            ...
                            <label htmlFor="details" >Details</label>
                            <textarea className="form-control form-control-mobile form-tex" id="details" name="details" value={formData.details} onChange={changeHandler} required maxLength={80}></textarea>
